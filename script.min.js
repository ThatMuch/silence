 ...
 *
 */
var $vpWidth=jQuery(window).width(),$root=$("html"),isTouch="ontouchstart"in document.documentElement;function debounce(t,e,i){var s;return function(){var n=this,o=arguments,r=function(){s=null,i||t.apply(n,o)},a=i&&!s;clearTimeout(s),s=setTimeout(r,e),a&&t.apply(n,o)}}isTouch?$root.attr("data-touch","true"):$root.attr("data-touch","false"),function(t){"use strict";jQuery(document).ready((function(t){t(".modal").appendTo("body"),t(".client__wrapper").owlCarousel({loop:!0,dots:!0,margin:20,autoplay:!0,responsive:{0:{items:2},668:{items:3},991:{items:5}}}),t(".modules__list").owlCarousel({loop:!0,dots:!0,margin:20,autoplay:!0,responsive:{0:{items:1,dots:!1,autoWidth:!0},668:{items:3},991:{items:4}}}),t(".box__list").owlCarousel({loop:!0,dots:!0,margin:40,autoplay:!0,responsive:{0:{items:1},668:{items:2},991:{items:3}}}),t(".post__list").owlCarousel({loop:!0,dots:!0,autoplay:!0,items:1})}))}(),
/*!
